...
class Register extends Component{
  ...
  <input type="text" placeholder="Enter your username" name="username" defaultValue={this.state.username} onChange={this.changehandle} required/>
    ...
    <input type="text" placeholder="Enter UserType" name="userType" defaultValue={this.state.userType} onChange={this.changehandle}required/>
    <label for="psw"><b>Image</b></label>
    <input type="file" placeholder="choose image" name="avatar" defaultValue={this.state.avatar} onChange={this.filehandle}required/>
